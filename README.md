...
- Creative DSP: `fold`, `crush`, `smoothstep(edge0, edge1, x)`, `noise(seed)`, `gt/lt/ge/le`, `select(cond, a, b)`, `pulse(freqHz, duty)`, `env(x, attack, release [, id])`, `lpf1(x, coeff [, id])`, `slew(target, speed [, id])`
